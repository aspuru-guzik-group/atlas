...
planner = BoTorchPlanner(goal='minimize', num_init_design=5) # instantiate GPPlanner 
planner.set_param_space(surface.param_space)

while len(campaign.observations.get_values()) < 30:
    samples = planner.recommend(campaign.observations) # ask planner for parameters (list of ParameterVectors)
