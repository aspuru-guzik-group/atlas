...
def mixed_disc_cont(init_design_strategy):
...
def mixed_cat_cont(init_design_strategy):
...
def mixed_cat_disc(init_design_strategy):
...
def mixed_cat_disc_cont(init_design_strategy):
...
if __name__ == "__main__":
	...
	mixed_disc_cont('random')
	mixed_cat_cont('random')
	mixed_cat_disc('random')
	mixed_cat_disc_cont('random')
