...
supported_distributions = [
    'BoundedUniform', 'FoldedNormal', 'FrozenCategorical', 'Normal', 'Uniform',
    'TruncatedUniform', 'FrozenNormal', 'Gamma', 'FrozenPoisson',
    'TruncatedNormal', 'Poisson', 'Categorical', 'FrozenDiscreteLaplace',
    'FrozenGamma', 'DiscreteLaplace', 'FrozenUniform',
]



def get_golem_dists(
        golem_config: Dict[str, Any], param_space: ParameterSpace,
    ...
    for param in param_space:
        ...
        if param.name in golem_params:
            if isinstance(golem_config[param.name], dict):
                ...
                distributions.append( get_dist_from_type(dist_type, dist_params) )
